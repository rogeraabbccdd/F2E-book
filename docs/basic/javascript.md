...
```html
<html>
  <img id="example4-img" src="/images/ch1/light_off.gif" width="100" height="180">
  點擊燈泡來開關這盞燈
</html>
<script>
  let img = document.getElementById("example4-img");
  img.onclick = () => {
      if(img.src.match("on")) img.src = "/images/ch1/light_off.gif";
      else img.src = "/images/ch1/light_on.gif";
  }
</script>
```
:::
